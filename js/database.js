...
export const firstPlayerConditions = [
    "Той хто наймолодший!",
    "Той хто останнім грав у настілку!",
    "Грішник, який має найбільше непройдених ігор!",
    "Той хто сьогодні прокинувся найраніше!",
    "Той у кого найвищий зріст!",
    "Той хто сидить зліва від тебе!",
    "Власник цієї гри!",
    "Той, хто першим торкнеться носа!",
    "Той, в кого найменший розмір взуття!",
    "Той, хто останнім пив каву!"
];
